var nerve = (function( templateStruct, data ) {
	...
	var normalizeFunction = function( func ) {
	...
	var sliceReturnBlock = function( string ) {
	...
	var parseReturnBlock = function( string ) {
	...
	var render = function( templateStruct ) {
		var templateString = stringify( normalize( templateStruct ) );
